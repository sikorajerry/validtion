...
public class ITUtility20Input {
    ...
    private final static String GENERATED_PATH = "utility20_input/";
    ...
    public void convertToGeneric20() throws Exception{
        ...
        InputStream inputStream = new FileInputStream("./testfiles/utility20_input/2_input_utility20_ECB+ECB_EXR+1.0.xml");
        ...
        // make the conversion
        TestConverterUtil.convert(  Formats.UTILITY_SDMX,
    ...
    @Test
    public void convertToStructureSpecificTS() throws Exception{
		String resultFileName = "2_output_structureSpecificTS21_ECB+ECB_EXR1+1.0.xml"; 
		String completeResultTargetFileName = IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH + IntegrationTestsUtils.GENERATED_NAME + resultFileName;
		String completeResultTestFilesFileName = IntegrationTestsUtils.TEST_FILES_NAME + GENERATED_PATH + resultFileName;
        ...
        sdmxOutputConfig.setReportingStartYearDate("--11-12");
    ...
    @Test
    public void convertToMultiLevelCsv() throws Exception{
		String resultFileName = "2_output_multiLevelCsv_ECB+ECB_EXR1+1.0.xml"; 
		String completeResultTargetFileName = IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH + IntegrationTestsUtils.GENERATED_NAME + resultFileName;
		String completeResultTestFilesFileName = IntegrationTestsUtils.TEST_FILES_NAME + GENERATED_PATH + resultFileName;
        ...
        csvOutputConfig.setLevels(4);
		csvOutputConfig.setColumnMapping(
		        csvService.buildOutputDimensionLevelMapping(new FileInputStream("./testfiles/utility20_input/mapping4Levels.xml")));
        // make the conversion
		TestConverterUtil.convert(  Formats.UTILITY_SDMX,
    ...
    public void convertToCsv() throws Exception{
		String resultFileName = "2_output_csv_ECB+ECB_EXR1+1.0.xml"; 
		String completeResultTargetFileName = IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH + IntegrationTestsUtils.GENERATED_NAME + resultFileName;
    ...
    @Test
    public void convert2ToGeneric20() throws Exception{
		String resultFileName = "3_output_generic20_UOE_NON_FINANCE+ESTAT+0.4.xml"; 
		String completeResultTargetFileName = IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH + IntegrationTestsUtils.GENERATED_NAME + resultFileName;
		String completeResultTestFilesFileName = IntegrationTestsUtils.TEST_FILES_NAME + GENERATED_PATH + resultFileName;
		
		Files.createDirectories(Paths.get(IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH));
		
        InputStream inputStream = new FileInputStream("./testfiles/utility20_input/3_input_utility20_UOE_NON_FINANCE+ESTAT+0.4.xml");
    ...
    public void convertToUtility() throws Exception{
		String resultFileName = "3_utility20FromUtility20_UOE_NON_FINANCE+ESTAT+0.4.xml"; 
		String completeResultTargetFileName = IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH + IntegrationTestsUtils.GENERATED_NAME + resultFileName;
		
		Files.createDirectories(Paths.get(IntegrationTestsUtils.TARGET_NAME + GENERATED_PATH));
		
    	//expected to fail because the input format is the same as output format
